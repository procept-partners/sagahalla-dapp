...
from mana_api.app.models.project import Task, Epic, SubProject, Project  # Assuming these are defined in models.py

# Define the base directory relative to the app
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
PROPOSALS_DIR = os.path.join(BASE_DIR, "mana_gov", "proposal_and_plan")
