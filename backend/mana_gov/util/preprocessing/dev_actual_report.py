...
# Main function
def main():
    dev_reports_folder = "backend/mana_gov/project_execution/dev_reports"  # Folder containing all the dev reports
    output_folder = "backend/mana_gov/project_execution/output_reports"  # Folder to save the individual and combined JSON reports
    project_name = "Saga Mana Project"  # The name of the project

    # Load budget data
    budget_data = load_json("backend/mana_gov/project_execution/hackathon_proposal.json")

    # Load role multipliers and global average rates
    role_multiplier_data = load_json("backend/mana_gov/proposal_and_plan/role_multipliers.json")
