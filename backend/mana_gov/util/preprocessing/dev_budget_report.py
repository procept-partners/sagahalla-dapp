...
from fastapi.app.models.project import Project
...
combined_output_file_path = os.path.join(app_root, "backend", "mana_gov", "proposal_and_plan", "hackathon_dev_project_budget.json")
