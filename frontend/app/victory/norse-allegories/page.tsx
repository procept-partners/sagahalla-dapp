...
export default function NorseAllegoriesPage() {
  return (
    <div className="flex min-h-screen flex-col bg-purple-custom text-white">
      ...
      <main className="flex-grow p-8 space-y-8">
        <div className="space-y-6">
          <h1 className="title text-4xl font-bold mb-6">Norse Allegories</h1>
          
          <h2 className="section-header text-3xl font-semibold mt-8 mb-4">The Role of Norse Mythology in the SagaHalla Cooperative</h2>
          ...
          <h2 className="section-header text-3xl font-semibold mt-8 mb-4">A Journey Through Norse Mythology and its Influence on Token Design in SagaHalla</h2>

          {/* Sections with Subheadings */}
          <div className="space-y-6">
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">Yggdrasil, the World Tree</h3>
            <p className="paragraph leading-relaxed">
            ...
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">The Norns</h3>
            <p className="paragraph leading-relaxed">
            ...
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">The Ring of Fire</h3>
            <p className="paragraph leading-relaxed">
            ...
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">Tyr and the Sacrifice for Fair Governance</h3>
            <p className="paragraph leading-relaxed">
            ...
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">The Wisdom of Mimir’s Well</h3>
            <p className="paragraph leading-relaxed">
            ...
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">The Mead of Poetry</h3>
            <p className="paragraph leading-relaxed">
            ...
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">Heimdall, the Vigilant Guardian</h3>
            <p className="paragraph leading-relaxed">
            ...
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">Frigg and Foresight</h3>
            <p className="paragraph leading-relaxed">
            ...
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">Loki’s Trickery and Consequences</h3>
            <p className="paragraph leading-relaxed">
            ...
            <h3 className="sub-section-header text-2xl font-medium mt-6 mb-3">Baldr’s Resurrection</h3>
            <p className="paragraph leading-relaxed">
